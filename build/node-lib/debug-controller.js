...
const _calc_distance_1 = require("./_calc-distance");
...
class DebugController {
    ...
    printDebugLinesForItem(index, focusableItem) {
        ...
        if (topIndex !== null) {
            ...
            this.printDebugLine((0, _calc_distance_1.calcDistance)(xDist, yDist), (currentItemMetrics.center.x - 5), currentItemMetrics.top, markerColor, angle);
        }
        ...
        if (bottomIndex !== null) {
            ...
            this.printDebugLine((0, _calc_distance_1.calcDistance)(xDist, yDist), (currentItemMetrics.center.x + 5), currentItemMetrics.bottom, markerColor, angle);
        }
        ...
        if (leftIndex !== null) {
            ...
            const angle = ((Math.atan2(xDist, yDist) * 180) / Math.PI) + 180;
            this.printDebugLine((0, _calc_distance_1.calcDistance)(xDist, yDist), currentItemMetrics.left, currentItemMetrics.center.y + 5, markerColor, angle);
        }
        ...
        if (rightIndex !== null) {
            ...
            const angle = ((Math.atan2(xDist, yDist) * 180) / Math.PI) + 180;
            this.printDebugLine((0, _calc_distance_1.calcDistance)(xDist, yDist), currentItemMetrics.right, currentItemMetrics.center.y - 5, markerColor, angle);
        }
    }
