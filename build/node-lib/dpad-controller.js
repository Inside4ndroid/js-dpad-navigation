...
exports.DpadController = void 0;
const _focusable_item_1 = require("./_focusable-item");
...
class DpadController {
    ...
    findFocusableItems() {
        ...
        Array.from(focusableItems).forEach(fi => {
            this.addFocusableItem(new _focusable_item_1.FocusableItem(fi));
        });
    }
    addFocusableItem(i) {
    ...
    verticalDistance(fromMetrics, toMetrics, higher, lower) {
        ...
        return (0, _calc_distance_1.calcDistance)(x, y);
    }
...
//# sourceMappingURL=dpad-controller.js.map